...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li class='previous'><a href='".$path."$this->_instance=$prev"."$ext'><span><i class=\"icofont-arrow-left\"></i></span></a></li>";
		else
		    $pagination.= "<li><a href='#'><span><i class=\"icofont-arrow-left\"></i></span></a><li>";
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'><span><i class=\"icofont-arrow-right\"></i></span></a></li>";
		else
		    $pagination.= '<li><a href="#"><span><i class="fas fa-angle-right"></i></span></a></li>';
		    $pagination.= "</ul></div>\n";       
		}
